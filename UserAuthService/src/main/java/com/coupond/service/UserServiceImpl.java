...
public class UserServiceImpl implements UserService {
	...
	public UserDto registerUser(RegisterDto newUser) throws UserAlreadyExistsException {
		...
		return new UserDto(savedUser.getUserId(), savedUser.getUsername(), savedUser.getEmail(), savedUser.getRole(),
				savedUser.getPhoneNumber(), new ArrayList<>());
	}
	...
	public List<UserDto> getAllUsers() {
		...
		for (User user : users) {
			...
			if (strs != null) {
				...
				udtos.add(new UserDto(user.getUserId(), user.getUsername(), user.getEmail(), user.getRole(),
						user.getPhoneNumber(), coupons));
			} else {
				udtos.add(new UserDto(user.getUserId(), user.getUsername(), user.getEmail(), user.getRole(),
						user.getPhoneNumber()));
			}
	...
	public UserDto getUserByUsername(String username) throws UserNotFoundException {
		...
		return new UserDto(user.getUserId(), user.getUsername(), user.getEmail(), user.getRole(), user.getPhoneNumber(),
				coupons);
	}
	...
	public UserDto updateUser(UpdateUserDto user) throws UserNotFoundException {
		...
		return new UserDto(updatedUser.getUserId(), updatedUser.getUsername(), updatedUser.getEmail(),
				updatedUser.getRole(), updatedUser.getPhoneNumber(), coupons);
	}
	...
	@Override
	public List<CouponDto> buyCoupons(String username, List<String> listOfCoupons)
